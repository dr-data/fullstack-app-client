...
export default function TicketItem(props) {
    ...
    return (
        <div className='ticketItem'>
            <p className='riskText'>We calculated that the risk of this ticket being a fraud is around {parseInt(props.risk)}%</p>
            <img src={picture} alt='ticket' className='ticketImage' />
